...
for filename in os.listdir('output2/'):
    filepath = os.path.join('output2/', filename)
    try:
...
print("Total time take by DE_Entropy is : %s seconds" % (time.time() - start_time))
